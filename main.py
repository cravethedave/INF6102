...
if __name__ == '__main__':
    ...
    if args.agent == "naive":
        ...
        # Your nice agent
        solution = first_solution.solve(instance)
    else:
    ...
    pizzeria_cost, pizzeria_cost_matrix, pizzeria_validity, pizzeria_validity_matrix = instance.solution_pizzeria_cost_and_validity(
        solution)
    mine_cost, mine_cost_matrix, mine_validity, mine_validity_matrix = instance.solution_mine_cost_and_validity(
        solution)
    route_cost, route_cost_matrix, route_validity, route_validity_matrix = instance.solution_route_cost_and_validity(
        solution)
